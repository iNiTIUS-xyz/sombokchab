...
use App\PaymentGateway\Gateways\AbaPayway;
...
use Xgenious\Paymentgateway\Base\Gateways\AcledaPay;
...
class PaymentGatewaySetup
{
    ...
    public function abapayway()
    {
        return new AbaPayway();
    }
    
    public function acledapay()
    {
        return new AcledaPay();
    }
