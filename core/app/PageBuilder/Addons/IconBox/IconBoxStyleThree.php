...
class IconBoxStyleThree extends PageBuilderBase
{
    ...
    /**
     * preview_image
     * this method must have to implement by all widgets to show a preview image at an admin panel so that user knows about the design which he want to use
     * @since 1.0.0
     * */
    ...
    {
        return $this->renderBlade('iconbox.iconbox-03');
    }
}