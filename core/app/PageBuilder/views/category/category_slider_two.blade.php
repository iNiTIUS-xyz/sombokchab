...
<div class="random-product-area-wrapper">
                    ...
                    <div class="single-random-item">
                        <div class="tag-box">
                            <a href="{{ $category_route }}"
                                class="tag">{{ html_entity_decode(optional($category)->title) }}</a>
                        </div>
                        <a href="{{ $category_route }}">
                            <span class="product-bg-img bg-size-cover" {!! render_background_image_markup_by_attachment_id(optional($category)->image) !!} data-width="100%"
                                data-height="400"></span>
                        </a>
                    </div>
                </div>
            @endforeach
