    ...
    public function render_dynamic_pages_list($dynamic_page_list, $lang): string
    {
        ...
        foreach ($dynamic_page_list as $key => $page_details) {
            ...
            if ($page_details['query'] === 'old_lang') {
                ...
                $query->where([$page_details['status_column'] => $page_details['status_value']]);
            }
            ...
            $output .= '<button type="button"  class="cmn_btn btn_bg_profile btn-xs add_page_to_menu mt-3 ms-3">'.__('Add To Menu').'</button>';
