...
class BlogController extends Controller {
    ...
    public function store_new_blog(Request $request) {
        ...
        if ($blogExit) {
            return back()->with([
                'alert-type' => 'error',
                'message'    => __('Blog already exist with this title.'),
            ]);
        }
        ...
        return redirect()->back()->with([
            'message'    => __('Blog post added successfully.'),
            'alert-type' => 'success',
        ]);
    }
    ...
    public function clone_blog(Request $request) {
        ...
        return redirect()->back()->with([
            'message'    => __('Blog post cloned successfully.'),
            'alert-type' => 'success',
        ]);
    }
    ...
    public function update_blog(Request $request, $id) {
        ...
        return redirect()->back()->with([
            'message'    => __('Blog post updated successfully.'),
            'alert-type' => 'success',
        ]);
    }
    ...
    public function new_category(Request $request) {
        ...
        return redirect()->back()->with([
            'message'    => __('New category added successfully.'),
            'alert-type' => 'success',
        ]);
    }
    ...
    public function delete_category(Request $request, $id) {
        if (Blog::where('blog_categories_id', $id)->first()) {
            return redirect()->back()->with([
                'message'    => __('You Can Not Delete This Category, It Already Associated With A Post...'),
                'alert-type' => 'error',
            ]);
        }
    ...
    public function update_blog_single_page_settings(Request $request) {
        ...
        return redirect()->back()->with([
            'message'    => __('Blog single page settings updated successfully.'),
            'alert-type' => 'success',
        ]);
    }
    ...
    public function update_blog_page_settings(Request $request) {
        ...
        return redirect()->back()->with([
            'message'    => __('Blog page settings updated successfully.'),
            'alert-type' => 'success',
        ]);
    }
    ...
    public function statusChange(Request $request, $id) {
        ...
        return redirect()->back()->with([
            'message'    => __('Blog category status changed successfully.'),
            'alert-type' => 'success',
        ]);
    }
    public function blogStatusChange(Request $request, $id) {
        ...
        return redirect()->back()->with([
            'message'    => __('Blog status changed successfully.'),
            'alert-type' => 'success',
        ]);
    }
}
