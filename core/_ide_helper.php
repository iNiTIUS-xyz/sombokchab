...
namespace Xgenious\XgApiClient\Facades {
     ...
     */        class XgApiClient {
         ...
         *
         * @static 
         */        public static function extensionCheck($name)
        {
                        /** @var \Xgenious\XgApiClient\XgApiClient $instance */
                        return $instance->extensionCheck($name);
        }
                    /**
         * 
         *
         * @static 
         */        public static function downloadAndRunUpdateProcess($productUid, $isTenant, $getItemLicenseKey, $version)
        {
                        /** @var \Xgenious\XgApiClient\XgApiClient $instance */
                        return $instance->downloadAndRunUpdateProcess($productUid, $isTenant, $getItemLicenseKey, $version);
        }
                    /**
         * 
         *
         * @static 
         */        public static function generalDownload($url, $fields)
        {
                        /** @var \Xgenious\XgApiClient\XgApiClient $instance */
                        return $instance->generalDownload($url, $fields);
        }
                    /**
         * 
         *
         * @static 
         */        public static function chunkedDownload($url, $fields)
        {
                        /** @var \Xgenious\XgApiClient\XgApiClient $instance */
                        return $instance->chunkedDownload($url, $fields);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \Xgenious\XgApiClient\XgApiClient $instance */
                        return $instance->getFiles($directory);
        }
                    /**
         * 
         *
         * @static 
         */        public static function isDotFile($filename)
        {
                        /** @var \Xgenious\XgApiClient\XgApiClient $instance */
                        return $instance->isDotFile($filename);
        }
                    /**
         * 
         *
         * @static 
         */        public static function systemUpgradeWithLatestVersion($updateInfo)
        {
                        /** @var \Xgenious\XgApiClient\XgApiClient $instance */
                        return $instance->systemUpgradeWithLatestVersion($updateInfo);
        }
                    /**
         * 
         *
         * @static 
         */        public static function systemDbUpgrade($isTenant, $version)
        {
                        /** @var \Xgenious\XgApiClient\XgApiClient $instance */
                        return $instance->systemDbUpgrade($isTenant, $version);
        }
                    /**
         * 
         *
         * @static 
         */        public static function activeLicense($licenseCode, $envatoUsername)
        {
                        /** @var \Xgenious\XgApiClient\XgApiClient $instance */
                        return $instance->activeLicense($licenseCode, $envatoUsername);
        }
                    /**
         * 
         *
         * @static 
         */        public static function checkForUpdate($licenseKey, $getItemVersion)
        {
                        /** @var \Xgenious\XgApiClient\XgApiClient $instance */
                        return $instance->checkForUpdate($licenseKey, $getItemVersion);
        }
                    /**
         * 
         *
         * @static 
         */        public static function VerifyLicense($purchaseCode, $email, $envatoUsername)
        {
                        /** @var \Xgenious\XgApiClient\XgApiClient $instance */
                        return $instance->VerifyLicense($purchaseCode, $email, $envatoUsername);
        }
                    /**
         * 
         *
         * @static 
         */        public static function getFilePath($file, $getFileRepalcePath)
        {
                        /** @var \Xgenious\XgApiClient\XgApiClient $instance */
                        return $instance->getFilePath($file, $getFileRepalcePath);
        }
            }
    }
...
namespace Illuminate\Database\Query {
     ...
     */        class Builder {
         ...
         * @param mixed $where
         * @static 
         */        public static function joinSubLateral($query, $as, $first, $operator = null, $second = null, $type = 'inner', $where = false)
        {
                        return \Illuminate\Database\Query\Builder::joinSubLateral($query, $as, $first, $operator, $second, $type, $where);
        }
            }
    }
...
namespace  {
            ...
            class XgApiClient extends \Xgenious\XgApiClient\Facades\XgApiClient {}
