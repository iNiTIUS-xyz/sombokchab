            ...
            <div class="form-row">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <select name="item_color[]" id="item_color" class="form-select">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="item_additional_price[]" id="item_additional_price"
                            ...
                            @if (isset($inventoryDetail)) value="{{ optional($inventoryDetail)->additional_price ?? 0 }}" @endif>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        @endphp
                        <x-media-upload :title="__('Attribute Image')" :id="$image_id" :name="'item_image[]'" :dimentions="'1280x1280'" />
                    </div>
                </div>
            </div>
            <div class="item_selected_attributes">
                @if (isset($inventoryDetail) && !is_null($inventoryDetail) && !is_null($inventoryDetail->includedAttributes))
                    @foreach ($inventoryDetail->includedAttributes as $attribute)
                        <div class="form-row">
                            <input type="hidden" name="item_attribute_id[{{ $key }}][]"
                                value="{{ $attribute->id }}">
                            <div class="col">
                                <div class="form-group">
            ...
            <div class="form-row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <select class="form-select item_attribute_name">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <select class="form-select item_attribute_value">
