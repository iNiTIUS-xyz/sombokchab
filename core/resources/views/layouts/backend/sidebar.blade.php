    ...
    <div class="dashboard-close-main">
        ...
        <div class="dashboard-bottom custom__form mt-4" id="sidbar-menu-wrap">
            <ul class="dashboard-list pb-5">
                ...
                @canany(['view-customer', 'add-customer', 'edit-customer', 'delete-customer'])
                ...
                @canany(['send-mail-to-subscriber', 'view-subscriber'])
                ...
                @if (moduleExists('Refund'))
                    @canany(['view-refund-request', 'edit-refund-request', 'manage-refund-request-settings'])
                        {{--                Wallet Manage                 --}}
                ...
                @if (moduleExists('Order'))
                    @canany(['view-order', 'add-order', 'edit-order', 'delete-order'])
                        {{-- Order Manage --}}
                ...
                @canany(['manage-country-province-city'])
                    <li class="main_dropdown @if (request()->is([
                            'admin-home/country',
                            'admin-home/country/*',
                            'admin-home/state',
                ...
                @canany(['view-attribute', 'add-attribute', 'edit-attribute'])
                    <li class="main_dropdown @if (request()->is([
                            'admin-home/units',
                            'admin-home/tags',
                ...
                @canany(['view-vendor', 'add-vendor', 'edit-vendor'])
                    <li class="main_dropdown @if (request()->is(['admin-home/vendor/*'])) active open @endif ">
                        <a href="#1" aria-expanded="true">
                            <i class="ti-user"></i>
                            <span>{{ __('Vendors Management') }}</span>
                        </a>
                        <ul class="collapse">
                            @can('view-vendor')
                ...
                @canany(['view-product', 'add-product'])
                    <li class="main_dropdown @if (request()->is(['admin-home/product', 'admin-home/product/*'])) active open @endif">
                        <a href="#1" aria-expanded="true">
                            <i class="ti-layout-tab"></i><span>{{ __('Products Management') }}</span>
                        </a>
                        <ul class="collapse">
                            @can('view-product')
                ...
                @canany(['view-campaign', 'add-campaign'])
                ...
                @canany(['manage-shipping-settings'])
                    <li class="main_dropdown @if (request()->is([
                            'admin-home/shipping/*',
                ...
                @canany(['view-blog', 'add-blog', 'manage-blog-settings'])
                ...
                @canany(['view-faq', 'add-faq', 'edit-faq', 'delete-faq'])
                ...
                @canany(['manage-appearance-settings'])
                    <li
                        class="main_dropdown
                            @if (request()->is([
