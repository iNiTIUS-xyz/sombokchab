            ...
            <div class="row justify-content-center margin-bottom-90 margin-top-90">
                <div class="col-lg-6">
                    <div class="login-form-wrapper">
                        ...
                        <form action="{{ route('tenant.user.email.verify') }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="form-group btn-wrapper my-3">
                                <button type="submit" id="verify"
                                    class="btn-default btn-block">{{ __('Verify Email') }}</button>
                            </div>
                            <div class="row mb-4 rmber-area">
                                <div class="col-12 text-center">
                                    <a href="{{ route('tenant.user.email.verify.resend') }}"
                                        id="send">{{ __('Send Verify Code Again?') }}</a>
                                </div>
                            </div>
                        </form>
                    </div>
