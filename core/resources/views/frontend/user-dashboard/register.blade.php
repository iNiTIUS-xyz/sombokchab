                    ...
                    <div class="sign-up register">
                        ...
                        <div class="form-wrapper">
                            ...
                            <form action="{{ route('tenant.user.register.store') }}" method="post"
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name"
                                                id="exampleInputEmail1" placeholder="Type your Name"
                                                value="{{ old('name') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="username"
                                                id="exampleInputEmail1" placeholder="Type Last Name"
                                                value="{{ old('username') }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">{{ __('Email Address') }}<span
                                            class="required">*</span></label>
                                    <input type="email" name="email" class="form-control" id="exampleInputEmail1"
                                        placeholder="Type your mail">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">{{ __('Country') }}<span
                                            class="required">*</span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="city" class="form-control" id="exampleInputEmail1"
                                        placeholder="Type your city" value="{{ old('city') }}">
                                </div>
                                    ...
                                    <div class="col-md-12 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="password_confirmation" class="form-control"
                                                id="exampleInputPassword1" placeholder="Confirmed Password">
                                        </div>
                                    </div>
                                </div>
