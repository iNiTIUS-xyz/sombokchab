...
@section('style')
    <x-media-upload.css/>
    <link rel="stylesheet" href="{{asset('assets/landlord/admin/css/materialdesignicons.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/tenant/frontend/user-dashboard/css/style.css')}}">
    <link rel="stylesheet" href="{{asset('assets/tenant/frontend/user-dashboard/css/custom-style.css')}}">
@endsection
                        ...
                        <div class="dashboard-close">
                            ...
                            <ul class="seller-dashboard-list">
                                ...
                                <li class="list @if(request()->routeIs('tenant.user.dashboard.package.order')) active @endif">
                                    <a href="{{route('tenant.user.dashboard.package.order')}}"> <i class="las la-tasks"></i> {{__('Payment Logs')}} </a>
                                </li>
