            ...
            @if ($modal)
                ...
                <div class="single-input mt-4">
                    ...
                    <input class="form--control" type="text" name="shipping_address_name"
                        value="{{ old('shipping_address_name') }}" placeholder="{{ __('Shipping Address Name') }}">
                </div>
                ...
                <div class="single-input mt-4">
                    ...
                    <textarea class="form--control" name="note" id="modal_note" placeholder="{{ __('Enter your note (optional)') }}">{{ old('note') }}</textarea>
                </div>
