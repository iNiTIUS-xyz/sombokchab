...
<div class="col-lg-12 col-ml-12">
    <div class="row g-4">
        <div class="col-lg-12">
            ...
            <div class="mb-4">
                @can('add-faq')
                <a href="#1" data-bs-toggle="modal" data-bs-target="#faq_add_modal" class="cmn_btn btn_bg_profile">{{
                    __('Add New FAQ') }}</a>
                @endcan
            </div>
            ...
            <form action="{{ route('admin.faq.update') }}" id="faq_edit_modal_form" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description_km" id="edit_description_km"
                            class="summernote summernote_km"></textarea>
                    </div>
                    <div class="form-group">
