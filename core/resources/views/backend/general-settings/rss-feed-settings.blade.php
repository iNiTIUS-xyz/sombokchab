                ...
                <div class="dashboard__card__body custom__form mt-4">
                    ...
                    <form action="{{ route('admin.general.rss.feed.settings') }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="site_rss_feed_title" id="site_rss_feed_title" class="form-control"
                                placeholder="{{ __('Enter RSS feed title') }}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="site_rss_feed_description" id="site_rss_feed_description" cols="30" rows="5"
                                class="form-control"
                                placeholder="{{ __('Enter RSS Feed Description') }}">{{ get_static_option('site_rss_feed_description') }}</textarea>
                        </div>
                        <div class="form-group">
