                ...
                <div class="dashboard__card__body custom__form mt-4">
                    ...
                    <form action="{{ route('admin.general.email.settings') }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">{{ __('this message will show when any one contact you
                                via contact page form.') }}</small>
                        </div>
                        <div class="form-group">
                            <label for="get_in_touch_mail_success_message">{{ __('Get In Touch Form Success Message')
                                }}</label>
