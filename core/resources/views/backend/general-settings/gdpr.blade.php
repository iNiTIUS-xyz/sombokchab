                ...
                <div class="dashboard__card__body custom__form mt-4">
                    <form action="{{ route('admin.general.gdpr.settings') }}" method="POST"
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="site_gdpr_cookie_more_info_label">{{ __('GDPR More Info Link Label')
                                        }}</label>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">{{ __('Enter more info link user {url} to point
                                        the site address, example: {url}/about , it will be converted to
                                        www.yoursite.com/about') }}</small>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="site_gdpr_cookie_accept_button_label">{{ __('GDPR Cookie Accept Button
                                        Label') }}</label>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="site_gdpr_cookie_decline_button_label">{{ __('GDPR Cookie Decline Button
                                        Label') }}</label>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="site_gdpr_cookie_enabled"><strong>{{ __('GDPR Cookie Enable/Disable')
                                            }}</strong></label>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">
                                        {{ __('Set GDPR cookie delay time, it mean the notification will show after this
                                        time. number count as mili seconds. eg: 5000, means 5seconds') }}
                                    </small>
                                </div>
                            </div>
                            <div class="col-sm-12">
