                        ...
                        <div class="row g-4">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <small>{{ __('You change site main color from here, it will replace website main
                                        color') }}</small>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <small>{{ __('You change site secondary color from here, it will replace website
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <small>{{ __('You can change site heading color from there , when you chnage this
                                        color it will reflect the color in all the heading like (h1,h2,h3,h4.h5.h6)')
                                        }}</small>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <small>{{ __('You change customer profile Color Settings color from here, it will
                                        replace website special color') }}</small>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
