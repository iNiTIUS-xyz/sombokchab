        ...
        <div class="col-12">
            ...
            <div class="dashboard__card">
                ...
                <div class="dashboard__card__body mt-4">
                    ...
                    <button type="submit" class="cmn_btn btn_bg_profile" id="check_update_status">{{ __('Check Update')
                        }}</button>
                    <button type="submit" class="cmn_btn btn_bg_profile" id="run_the_update_now">{{ __('Run Update')
                        }}</button>
