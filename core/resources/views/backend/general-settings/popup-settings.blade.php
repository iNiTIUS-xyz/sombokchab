                ...
                <div class="dashboard__card__body custom__form mt-4">
                    <form action="{{ route('admin.general.popup.settings') }}" method="Post"
                            ...
                            <div class="tab-pane fade @if ($key == 0) show active @endif"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="popup_selected_{{ $lang->slug }}_id" class="form-control"
                                        ...
                                        <option @if (get_static_option('popup_selected_' . $lang->slug . '_id') ==
                        ...
                        <div class="form-group">
                            ...
                            <label class="switch">
                                <input type="checkbox" name="popup_enable_status" @if
                                    (!empty(get_static_option('popup_enable_status'))) checked @endif
                                    id="popup_enable_status">
                        ...
                        <button type="submit" class="cmn_btn btn_bg_profile" id="db_backup_btn">{{ __('Save Changes')
                            }}</button>
                    </form>
                </div>
            </div>
