                ...
                <div class="dashboard__card__body custom__form mt-4">
                    <form action="{{ route('admin.general.basic.settings') }}" method="POST"
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <x-media-upload name="og_meta_image_for_site" :title="__('Og Meta Image For Site')"
                                        :oldimage="get_static_option('og_meta_image_for_site')" />
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" name="enable_buy_now_button_on_shop_page" @if
                                            (!empty(get_static_option('enable_buy_now_button_on_shop_page'))) checked
                                            @endif id="enable_buy_now_button_on_shop_page">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" name="site_sticky_navbar_enabled" @if
                                            (!empty(get_static_option('site_sticky_navbar_enabled'))) checked @endif
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <label class="switch yes">
                                        <input type="checkbox" name="site_maintenance_mode" @if
                                            (!empty(get_static_option('site_maintenance_mode'))) checked @endif
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" name="site_admin_panel_nav_sticky" @if
                                            (!empty(get_static_option('site_admin_panel_nav_sticky'))) checked @endif
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" name="site_payment_gateway" @if
                                            (!empty(get_static_option('site_payment_gateway'))) checked @endif
                                            id="site_payment_gateway">
                                        <span class="slider onff"></span>
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" name="disable_backend_preloader" @if
                                            (!empty(get_static_option('disable_backend_preloader'))) checked @endif
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" name="site_force_ssl_redirection" @if
                                            (!empty(get_static_option('site_force_ssl_redirection'))) checked @endif
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" name="disable_user_email_verify" @if
                                            (!empty(get_static_option('disable_user_email_verify'))) checked @endif
                                            id="disable_user_email_verify">
                                        <span class="slider onff"></span>
                                    </label>
                                    <small class="info-text">
                                        {{ __('No, means user must have to verify their email account in order access
                                        his/her dashboard.') }}
                                    </small>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" name="preloader_status" @if
                                            (!empty(get_static_option('preloader_status'))) checked @endif
                                            id="preloader_status">
                                        <span class="slider onff"></span>
                                    </label>
