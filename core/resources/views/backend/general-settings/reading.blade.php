                ...
                <div class="dashboard__card__body custom__form mt-4">
                    <form action="{{ route('admin.general.reading') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="home_page" id="home_page" class="form-select">
                                        ...
                                        <option value="{{ $page->id }}" @if ($page->id ==
                                            get_static_option('home_page')) selected @endif>{{ $page->title }}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="product_page" id="product_page" class="form-select">
                                        @foreach ($all_pages as $page)
                                        <option value="{{ $page->id }}" @if ($page->id ==
                                            get_static_option('product_page')) selected @endif>{{ $page->title }}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="blog_page" id="blog_page" class="form-select">
                                        @foreach ($all_pages as $page)
                                        <option value="{{ $page->id }}" @if ($page->id ==
                                            get_static_option('blog_page')) selected @endif>{{ $page->title }}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-4">
                                <button type="submit" id="update" class="cmn_btn btn_bg_profile">{{ __('Update')
                                    }}</button>
                            </div>
                        </div>
                    </form>
