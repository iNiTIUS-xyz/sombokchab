                        ...
                        <table class="table table-default">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="language__list">
                                            ...
                                            <li><strong class="language__list__strong">{{ 'Direction' }}</strong>
                                                <span class="language__list__span">{{ strtoupper($data->direction)
                                                    }}</span>
                                            </li>
                                            <li><strong class="language__list__strong">{{ 'Slug' }}</strong>
                                                <span class="language__list__span">{{ strtoupper($data->slug) }}</span>
                                            </li>
                                            <li><strong class="language__list__strong">{{ 'Status' }}</strong>
                                                <span class="language__list__span">{{ strtoupper($data->status)
                                                    }}</span>
                                            </li>
                                        </ul>
                                    </td>
                                    <td>
                                        @if ($data->default == 1)
                                        <a href="#1" class="btn btn-success btn-sm mb-2 me-1">{{ __('Default') }}</a>
                                        @else
                                    ...
                                    <td>
                                        ...
                                        @endcan
                                        @can('manage-site-settings')
                                        <a href="#1" data-bs-toggle="modal" data-bs-target="#language_item_edit_modal"
