                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{ __('Enter additional information tab text') }}"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <x-media-upload :name="'related_product_image'"
                                        :oldimage="get_static_option('related_product_image')"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="sidebar_position" id="sidebar_position">
                                        <option value="left" @if (get_static_option('sidebar_position')=='left' )
                                            selected @endif>
                                            {{ __('Left') }}
                                        </option>
                                        <option value="right" @if (get_static_option('sidebar_position')=='right' )
                                            selected @endif>
                                            {{ __('Right') }}
                                        </option>
                                    </select>
