                            ...
                            <div class="row g-4">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="{{ __('Enter checkout page no product text') }}"
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="{{ __('Enter checkout login button text') }}"
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="{{ __('Enter coupon text') }}" class="form-control"
                                            id="enter_coupon_text" name="enter_coupon_text"
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="{{ __('Enter apply coupon button text') }}"
                                            class="form-control" id="apply_coupon_btn_text" name="apply_coupon_btn_text"
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="{{ __('Enter checkout billing city') }}"
                                            class="form-control" id="checkout_billing_city" name="checkout_billing_city"
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="{{ __('Enter checkout billing zipcode') }}"
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="{{ __('Enter checkout billing address') }}"
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="{{ __('Enter ship to another text') }}"
                                            class="form-control" id="ship_to_another_text" name="ship_to_another_text"
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="{{ __('Enter vat text') }}" class="form-control"
                                            id="vat_text" name="vat_text" value="{{ get_static_option('vat_text') }}">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="{{ __('Enter checkout place order') }}"
                                            class="form-control" id="checkout_place_order" name="checkout_place_order"
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="{{ __('Enter checkout return cart') }}"
                                            class="form-control" id="checkout_return_cart" name="checkout_return_cart"
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="{{ __('Enter checkout page terms text') }}"
                                        ...
                                        <small>
                                            {!! __('For example: I have read and agree to the Website <b>[lnk]</b>terms
                                            & conditions<b>[/lnk]</b>.') !!}
                                        </small>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select name="checkout_page_terms_link_url" id="checkout_page_terms_link_url"
                                            ...
                                            <option value="{{ $page->slug }}" @if ($page->slug ==
                                                get_static_option('checkout_page_terms_link_url')) selected @endif>
                                                {{ $page->title }}
                                            </option>
                                            @endforeach
                                        </select>
