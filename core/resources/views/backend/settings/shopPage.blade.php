                        ...
                        <div class="row g-4">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="default_item_count" class="form-control"
                                        placeholder="{{ __('Enter number of products to show by default') }}"
                            ...
                            <div class="col-sm-12">
                                <div class="form-col">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" id="sidebar_visibility" name="sidebar_visibility" @if
                                            (!empty(get_static_option('sidebar_visibility'))) checked @endif>
                        ...
                        <div class="row g-4 mt-2">
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" id="shop_product_search" name="shop_product_search" @if
                                            (!empty(get_static_option('shop_product_search'))) checked @endif>
                                        <span class="slider"></span>
                                    </label>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" id="shop_filter_by_average_rating"
                                            name="shop_filter_by_average_rating" @if
                                            (!empty(get_static_option('shop_filter_by_average_rating'))) checked @endif>
                                        <span class="slider"></span>
                                    </label>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" id="shop_filter_by_category"
                                            name="shop_filter_by_category" @if
                                            (!empty(get_static_option('shop_filter_by_category'))) checked @endif>
                                        <span class="slider"></span>
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" id="shop_filter_by_price" name="shop_filter_by_price" @if
                                            (!empty(get_static_option('shop_filter_by_price'))) checked @endif>
                                        <span class="slider"></span>
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" id="shop_filter_by_tags" name="shop_filter_by_tags" @if
                                            (!empty(get_static_option('shop_filter_by_tags'))) checked @endif>
                                        <span class="slider"></span>
                                    </label>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" id="shop_filter_by_location"
                                            name="shop_filter_by_location" @if
                                            (!empty(get_static_option('shop_filter_by_location'))) checked @endif>
                                        <span class="slider"></span>
                                    </label>
                                </div>
                            </div>
