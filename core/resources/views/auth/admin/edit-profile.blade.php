                    ...
                    <form action="{{ route('admin.profile.update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="media-upload-btn-wrapper">
                                <div class="img-wrap">
                                    @php
                                    $profile_img = \App\Http\Services\Media::render_image(
                                    $image,
                                    render_type: 'path',
                                    size: 'thumb',
                                    );
                                    ...
                                    <div class="attachment-preview">
                                        <div class="thumbnail">
                                            <div class="centered">
                                                <img class="avatar user-thumb" src="{{ $profile_img }}"
                                                    alt="{{ auth()->user()->name }}">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <small class="info-text">{{ __('Recommended Image Size 100x100. Only Accept: jpg,png.jpeg.
                                Size less than 2MB') }}</small>
                        </div>
                        {{-- @can('manage-profile') --}}
                        <div class="form-group">
