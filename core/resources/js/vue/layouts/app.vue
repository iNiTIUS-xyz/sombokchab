                                    ...
                                    <div class="row g-4">
                                        <div class="col-xxl-8 col-lg-7">
                                            <div class="dashboard_posSystem__left">
                                                ...
                                                <div class="load-more-products text-center mt-5 mb-3" v-if="Products.pagination?.links?.next ?? false">
                                                    <a class="btn btn-info" @click.prevent="loadMore">Load More</a>
                                                </div>
                                            </div>
                                        </div>
...
export default {
    ...
    setup: (props, {emit}) => {
        ...
        function fetchProductData() {
            axios.get(window.appUrl + '/api/v1/product')
                .then((response) => {
        ...
        function searchProduct(data) {
            ...
            axios.get(window.appUrl + '/api/v1/product?' + data)
                .then((response) => {
        ...
        const loadMore = () => {
            fetchProductsPagination(Products.pagination?.links?.next ?? '')
        }
        const getAppUrl = () => {
