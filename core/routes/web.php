...
Route::group(['middleware' => ['setlang:frontend', 'globalVariable', 'maintains_mode', 'check.auth.vendor']], function () {
    ...
    Route::any('frontend/checkout/shipping/methods', 'FrontendController@checkoutShippingMethods')->name('frontend.checkout.shipping.methods');
    ...
    Route::prefix('user-home')->middleware(['userEmailVerify', 'setlang:frontend', 'globalVariable', 'maintains_mode'])->group(function () {
        ...
        Route::prefix('orders')->name('user.product.order.')->group(function () {
            ...
            Route::post('re/payment', 'UserDashboardController@payment')->name('payment.now');
...
Route::prefix('admin-home')->middleware(['setlang:backend', 'adminglobalVariable', 'auth:admin'])->group(function () {
    ...
    Route::group(['namespace' => 'Admin'], function () {
        ...
        Route::get('/website-visits/data', 'AdminDashboardController@getCustomerData')->name('websiteVisits.data'); // Note: now show getcustomer file. but we need to show getWebsiteData data.
