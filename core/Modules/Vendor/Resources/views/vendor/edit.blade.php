                                ...
                                <div class="row g-4 mt-1">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="single-input">
                                                            ...
                                                            <textarea name="description"
                                                                ...
                                                                placeholder="{{ __('Enter Description') }}" cols="30"
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <x-media.media-upload :old-image="$vendor?->vendor_shop_info?->cover_photo"
                                            :title="__('Cover Photo')" :name="'cover_photo_id'" :dimentions="'200x200'"
                                            type="vendor" />
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="row g-4">
                                                            ...
                                                            <div class="nice-select-two country_wrapper">
                                                                <select class="form-control" id="country_id"
                                                                    ...
                                                                    <option value="{{ $item->id }}" {{ $vendor?->
                                                                        vendor_address?->country_id == $item->id ?
                                                                        'selected' : '' }}>
                                                                        {{ $item->name }}</option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="nice-select-two state_wrapper">
                                                                <select class="form-control" id="state_id"
                                                                    ...
                                                                    <option value="{{ $state->id }}" {{ $vendor?->
                                                                        vendor_address?->state_id == $state->id ?
                                                                        'selected' : '' }}>
                                                                        {{ $state->name }}
                                                                    </option>
                                                                    @endforeach
                                                            ...
                                                            <div class="nice-select-two city_wrapper">
                                                                <select class="form-control" id="city_id" name="city_id"
                                                                    ...
                                                                    <option value="{{ $city->id }}" {{ $vendor?->
                                                                        vendor_address?->city_id == $city->id ?
                                                                        'selected' : '' }}>
                                                                        {{ $city->name }}</option>
                                                                    @endforeach
                                                                </select>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="single-input">
                                                            ...
                                                            <textarea cols="30" rows="10" name="address" type="text"
                                                                class="form--control radius-10"
