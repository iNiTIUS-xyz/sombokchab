...
@section('style')
    ...
    <style>
        ...
        .stat-wrapper {
            ...
            flex-wrap: wrap;
            gap: 20px;
            /* spacing like image 1 */
        }

        .stat-card {
            flex: 1 1 320px;
            /* auto wrap behaviour like image 1 */
            background: #f8f9fa;
            border: 1px solid #e5e7eb;
            /* same light grey border */
            border-radius: 6px;
            padding: 10px 14px;
            display: flex;
        ...
        /* Number text (same style as image 1) */
        .stat-value {
            font-size: 16px;
            font-weight: 600;
        }
                        ...
                        <div class="dashboard__card__body">
                            ...
                            <div class="row g-5">
                                ...
                                <div class="col-md-6">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="vendor_top_product_daily-tab"
                                                type="button">Daily</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="vendor_top_product_weekly-tab"
                                                type="button">Weekly</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="vendor_top_product_monthly-tab"
                                                type="button">Monthly</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="vendor_top_product_yearly-tab"
                                                type="button">Yearly</button>
                                        </li>
                                        <li class="nav-item">
                                            <input type="text" class="form-control date_range_picker"
                                                id="vendor_top_product_picker" />
                                        </li>
                                    </ul>

                                    <div class="mt-3 position-relative">
                                        <div id="vendor_top_product_chart"></div>
                                        <input id="vendor_top_product_scroll" class="form-range mt-2 w-100" type="range"
                                            min="0" max="0" value="0" step="1" />
                                    </div>
        ...
        <div class="col-lg-12 col-ml-12 mb-3">
            <div class="row">
                <div class="col-12">
                    <div class="dashboard__card">
                        <div class="dashboard__card__body">
                            <h4 class="my-3">Vendor Support Tickets</h4>
                            <div class="p-3 bg-light rounded-3">
                                <div class="row g-3 mb-2">
                                    <h6 class="text-center mb-0">Ticket Status</h6>
                                    <div class="row g-3 mb-2 mt-0">
                                        ...
                                        <div class="col-md-4">
                                            <div
                                                ...
                                                <span
                                                    class="fw-bold text-warning">{{ $supportTickets['all_open_tickets']->count() }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div
                                                ...
                                                <span class="fw-bold text-danger">
                                                    {{ $supportTickets['all_close_tickets']->count() }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <h6 class="text-center mb-0">Ticket Priority Status</h6>
                                    <div class="row g-3 mb-2 mt-0">
                                        <div class="col-md-4">
                                            <div
                                                class="d-flex justify-content-between align-items-center bg-light border rounded py-3 px-2">
                                                <span>Low Priority Tickets</span>
                                                {{-- <span class="fw-bold text-danger">{{ $rejectedProduct->count() }}</span> --}}
                                                <span class="fw-bold text-info">
                                                    {{ $supportTickets['all_low_tickets']->count() }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div
                                                class="d-flex justify-content-between align-items-center bg-light border rounded py-3 px-2">
                                                <span>Medium Priority Tickets</span>
                                                {{-- <span class="fw-bold text-danger">{{ $rejectedProduct->count() }}</span> --}}
                                                <span class="fw-bold text-warning">
                                                    {{ $supportTickets['all_medium_tickets']->count() }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div
                                                ...
                                                {{-- <span class="fw-bold text-danger">{{ $rejectedProduct->count() }}</span> --}}
                                                <span class="fw-bold text-danger">
                                                    {{ $supportTickets['all_high_tickets']->count() }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="dashboard__card__body">
                            <h4 class="my-3">Verifications</h4>
                            <div class="p-3 bg-light rounded-3">
                                ...
                                <div class="row g-3">
                                    ...
                                    {{-- <div class="col-md-4">
                                        <div
                                            ...
                                            <span class="fw-bold text-danger">{{ $processingWithdraw->count() }}</span>
            ...
            function makeBrushBarChart({
                        ...
                        chart: {
                            ...
                            events: {
                                selection: (ctx, {
                                    ...
                                    const minI = clamp(Math.round(xaxis.min), 0, Math.max(0, values
                                        .length - 1));
                                    const maxI = clamp(Math.round(xaxis.max), 0, Math.max(0, values
                                        .length - 1));
                                    applyViewport(minI, maxI, {
                                        from: 'nav'
                                    });
                ...
                elMain.addEventListener('wheel', (e) => {
                    ...
                    if (e.ctrlKey || e.metaKey) {
                        ...
                        const panStep = Math.max(1, Math.round((vMax - vMin + 1) * 0.1));
                        const dir = delta > 0 ? 1 : -1;
                        const newMin = clamp(vMin + dir * panStep, 0, Math.max(0, rawLabels.length - (vMax -
                            vMin + 1)));
                        const newMax = newMin + (vMax - vMin);
                        applyViewport(newMin, newMax);
                    }
