                                        ...
                                        <td class="price-td" data-label="Vendor Name">
                                            <div class="vendorList__flex">
                                                <div class="vendorList__thumb">
                                                    {!!
                                                    \App\Http\Services\Media::render_image($vendor?->vendor_shop_info?->logo,
                                                    attribute: "style='width:80px'") !!}
                                                </div>
                                                <div class="vendorList__inner">
                                                    <div class="vendorList__item">
                                                        <span class="vendorList__label vendor-label">{{ __('Shop Name:')
                                                            }}
                                                        </span>
                                                        <span class="vendorList__value vendor-value">
                                                    ...
                                                    <div class="vendorList__item">
                                                        <span class="vendorList__label vendor-label">{{ __('Shop
                                                            Number:') }}
                                                        </span>
                                                        <span class="vendorList__value vendor-value">
                                        ...
                                        <td>
                                            <div class="btn btn-sm m-0 p-0" style="font-size: small;">
                                                <button type="button"
                                                    ...
                                                    aria-expanded="false">
                                                    {{ ucfirst($vendor->is_vendor_verified == 0 ? __('Unverified') :
                                                    __('Verified')) }}
                                                </button>
            ...
            <div class="modal-body">
                <form action="{{ route('admin.vendor.individual-commission-settings') }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="commission_amount" id="amount" class="form-control form-control-sm"
