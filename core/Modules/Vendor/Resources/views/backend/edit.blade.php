                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="basic-info" role="tabpanel"
                                ...
                                <div class="row g-4 mt-1">
                                            ...
                                            <div class="dashboard__card__body custom__form mt-4 single-reg-form">
                                                    ...
                                                    <div class="nice-select-two">
                                                        <select id="business_type" name="business_type_id"
                                                            ...
                                                            <option value="{{ $item->id }}" {{ $item->id ==
                                                                $vendor->business_type_id ? 'selected' : '' }}>
                                                                {{ $item->name }}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="is_vendor_verified" class="form--control">
                                                        <option value="1" @if ($vendor->is_vendor_verified == 1)
                                                            selected @endif>
                                                            Yes
                                                        </option>
                                                        <option value="0" @if ($vendor->is_vendor_verified == 0)
                                                            selected @endif>
                                                            No
                                                        </option>
                                                    </select>
                                    ...
                                    <div class="col-lg-6">
                                        <x-media.media-upload :old-image="$vendor?->vendor_shop_info?->logo"
                                            :title="__('Logo')" :name="'logo_id'" :dimentions="'200x200'" />
                                        <x-media.media-upload :old-image="$vendor?->vendor_shop_info?->cover_photo"
                                            :title="__('Cover Photo')" :name="'cover_photo_id'"
                                            :dimentions="'200x200'" />
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="dashboard__card__body custom__form mt-4 single-reg-form">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="nice-select-two country_wrapper">
                                                        <select class="form-control" id="country_id" name="country_id">
                                                            ...
                                                            <option value="{{ $item->id }}" {{ $vendor?->
                                                                vendor_address?->country_id == $item->id ? 'selected' :
                                                                '' }}>
                                                                {{ $item->name }}
                                                            </option>
                                                            @endforeach
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="nice-select-two state_wrapper">
                                                        <select class="form-control" id="state_id" name="state_id">
                                                            ...
                                                            <option value="{{ $state->id }}" {{ $vendor?->
                                                                vendor_address?->state_id == $state->id ? 'selected' :
                                                                '' }}>
                                                                {{ $state->name }}
                                                            </option>
                                                            @endforeach
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="nice-select-two city_wrapper">
                                                        <select id="city_id" name="city_id" class="form-control">
                                                            ...
                                                            <option value="{{ $city->id }}" {{ $vendor?->
                                                                vendor_address?->city_id == $city->id ? 'selected' : ''
                                                                }}>
                                                                {{ $city->name }}
                                                            </option>
                                                            @endforeach
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="address" type="text"
                                                        ...
                                                        class="form--control radius-10">{{ $vendor?->vendor_address?->address }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="dashboard__card__body custom__form mt-4 single-reg-form">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $vendor?->vendor_shop_info?->location }}"
                                                        name="location" type="text" class="form--control radius-10"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $vendor?->vendor_shop_info?->facebook_url }}"
                                                        type="text" name="facebook_url" class="form--control radius-10"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $vendor?->vendor_shop_info?->website_url }}"
                                                        type="text" name="website_url" class="form--control radius-10"
                                                ...
                                                <div class="row mt-4">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label for="store_secondary_color">{{ __('Secondary Color')
                                                                }}</label>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label for="store_heading_color">{{ __('Heading Color')
                                                                }}</label>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label for="store_paragraph_color">{{ __('Paragraph Color')
                                                                }}</label>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="dashboard__card">
                                            <div class="dashboard__card__header">
                                                ...
                                                <br>
                                                @if ($vendor?->vendor_bank_info?->is_varify &&
                                                $vendor?->vendor_bank_info?->varify_at)
                                                <p class="text-success">
                                            ...
                                            <div class="dashboard__card__body custom__form mt-4 single-reg-form">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $vendor?->vendor_bank_info?->bank_email }}"
                                                        name="bank_email" type="text" class="form--control radius-10"
                                                        placeholder="{{ __('Enter email') }}">
                                                </div>
                                                <div class="form-group">
                                                    <label class="label-title color-light mb-2">
                                                    ...
                                                    <input value="{{ $vendor?->vendor_bank_info?->bank_code }}"
                                                        name="bank_code" type="tel" class="form--control radius-10"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="is_varify" class="form-control">
                                                        ...
                                                        <option value="1" @if ($vendor?->vendor_bank_info?->is_varify ==
                                                            1) selected @endif>
                                                            Verify
                                                        </option>
                                                        <option value="0" @if ($vendor?->vendor_bank_info?->is_varify ==
                                                            0) selected @endif>
                                                            Rejected
                                                        </option>
                                                    </select>
