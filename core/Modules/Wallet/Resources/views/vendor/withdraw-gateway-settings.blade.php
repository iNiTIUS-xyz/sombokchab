                    ...
                    <form method="post" action="{{ route('vendor.wallet.withdraw.gateway.update') }}"
                        ...
                        <div class="form-group">
                            ...
                            <select name="gateway_name" class="form-select gateway-name">
                                ...
                                <option {{ $savedGateway?->vendor_wallet_gateway_id === $gateway->id ? 'selected' : ''
                                    }}
                                    value="{{ $gateway->id }}"
                        ...
                        <div class="form-group gateway-information-wrapper">
                            ...
                            @endphp
                            @foreach (($gatewayFields?->filed ? unserialize($gatewayFields?->filed) : []) ?? [] as $key
                            => $filed)
                            @php
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="gateway_filed[{{ $key }}]" class="form-control"
                                    value="{{ $filed }}" placeholder="Enter {{ str_replace('_', ' ', $filed_name) }}" />
                            </div>
                            @endforeach
                        </div>
                        <div class="form-group">
