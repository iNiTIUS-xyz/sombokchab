    ...
    */
    ...
    $(document).on("click","#vendor-send-message-to-user", function (){
        ...
        if($('#vendor-message-footer #message').val().length > 0 || file !== undefined){
            ...
            send_ajax_request("post", form, "{{ route("vendor.chat.message-send") }}", function (){}, function (response){
    ...
    function fetch_chat_data(user_id, page = 1, callback){
        ...
        send_ajax_request("post", formData,`{{ route("vendor.chat.fetch-vendor-chat-record") }}?page=${page}`,function (){
