...
<div class="col-lg-12 col-ml-12">
    <div class="row g-4">
        <div class="col-12">
            ...
            <div class="mb-4">
                @can('add-coupon')
                <a href="#1" data-bs-toggle="modal" data-bs-target="#coupon_add_modal" class="cmn_btn btn_bg_profile">{{
                    __('Add New Coupon') }}</a>
                @endcan
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#1" data-bs-toggle="modal" title="{{ __('Edit Data') }}"
                                            ...
                                            data-code="{{ $data->code }}" data-discount_on="{{ $data->discount_on }}"
                                        ...
                                        <x-table.btn.swal.delete
                                            :route="route('admin.products.coupon.delete', $data->id)" />
                                        @endcan
                                    </td>
                                </tr>
                                @endforeach
                    ...
                    <form action="{{ route('admin.products.coupon.update') }}" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group" id="edit_form_products">
                                ...
                                <select name="products[]" id="edit_products" class="form-control wide select2" multiple>
                                </select>
                            </div>
                            <div class="row">
