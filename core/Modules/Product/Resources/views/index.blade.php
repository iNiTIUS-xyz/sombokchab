                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="category" class="form-control select2">
                                ...
                                <option value="{{ $category->name }}" @if (request('category')==$category->name)
                                    selected @endif>
                                    {{ $category->name }}
                                </option>
                                @endforeach
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="category" class="form-control select2">
                                ...
                                <option value="{{ $sub_category->name }}" @if (request('sub_category')==$sub_category->
                                    name) selected @endif>
                                    {{ $sub_category->name }}
                                </option>
                                @endforeach
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="from_price" class="form--control input-height-1" id="search-from_price"
                                        value="{{ request('from_price') }}" placeholder="{{ __('Enter Min Price') }}" />
                                </div>
                            </div>
