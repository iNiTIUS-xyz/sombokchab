@php
    ...
    $campaignProductEndDate = $product->campaign->end_date ?? ($product->campaign->end_date->end_date ?? null);
            ...
            <div class="product__card__cart mt-3">
                ...
                @else
                    @if (isset($attributes) && $attributes > 0)
                        <a href="#1" data-id="{{ $product->id }}" data-attributes="{{ $product->attribute }}"
                ...
                <div class="product__card__cart__right">
                    ...
                    @if (isset($attributes) && $attributes > 0)
                        <a href="#1" title="{{ __('View Details') }}"
