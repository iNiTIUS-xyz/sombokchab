        ...
        <div class="modal-content">
            <form action="" class="change-product-image-form">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="mediaUpdateModal">
                ...
                <div class="modal-body">
                    ...
                    <x-media-upload name="product_gallery" :multiple="true" :title="__('Select product gallery image')" />
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                        {{ __('Close') }}
                    </button>
                    <button type="button" class="btn btn-primary change-product-image-button">
