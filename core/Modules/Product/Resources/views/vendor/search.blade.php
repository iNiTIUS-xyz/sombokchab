            ...
            <tr class="table-cart-row">
                ...
                <td data-label="Actions">
                    <div class="action-icon">
                        <a href="{{ route('frontend.products.single', $product->slug) }}" class="icon eye"> <i
                                class="las la-eye"></i>
                        </a>
                        <a href="{{ route($route . '.products.edit', $product->id) }}" class="icon edit"> <i
                                class="las la-pen-alt"></i> </a>
                        <a href="{{ route($route . '.products.clone', $product->id) }}" class="icon clone"> <i
