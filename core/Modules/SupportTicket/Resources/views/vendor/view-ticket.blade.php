            ...
            <div class="dashboard__card">
                <div class="dashboard__card__header">
                    ...
                    <div class="btn-wrapper">
                        <a class="cmn_btn btn_bg_profile" href="{{ route('vendor.support.ticket.all') }}">{{ __('All
                            Tickets') }}</a>
                    </div>
                </div>
                            ...
                            <ul>
                                ...
                                <li><strong>{{ __('Status:') }}</strong>
                                    <span
                                        ...
                                        {{ ucfirst($ticket_details->status == 'close' ? __('Closed') :
                                        __($ticket_details->status)) }}
                                    </span>
                                </li>
                        ...
                        <div class="gig-message-start-wrap">
                            ...
                            <div class="all-message-wrap @if ($q == 'all') msg-row-reverse @endif">
                                ...
                                <form action="" method="get">
                                    ...
                                    <button class="load_all_conversation" type="submit">{{ __('load all message')
                                        }}</button>
                                </form>
                                @endif
                                ...
                                <div class="single-message-item @if ($msg->type == 'vendor') customer @endif">
                                    ...
                                    <div class="content">
                                        ...
                                        <a href="{{ asset('assets/uploads/ticket/' . $msg->attachment) }}" download
                                            class="anchor-btn">
                                            <strong>File: </strong>
                        ...
                        <div class="reply-message-wrap ">
                            ...
                            <form action="{{ route('vendor.support.ticket.send.message') }}" method="post"
                                ...
                                <div class="form-group mt-4">
                                    ...
                                    <textarea name="message" class="form-control d-none" cols="30" rows="5"
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="info-text d-block text-danger">
                                        {{ __('Max file size 200mb, only zip, png, gif, jpg, jpeg, pdf, docx, doc, odd
                                        file is allowed') }}
                                    </small>
                                </div>
