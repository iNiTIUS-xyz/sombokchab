                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title"
                                                value="{{ old('title') }}" placeholder="{{ __('Enter title (English)') }}"
                                                required="">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title_km"
                                                value="{{ old('title') }}" placeholder="{{ __('បញ្ចូលចំណងជើង (ខ្មែរ)') }}"
                                                required="">
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-5 mb-2">
                                                            <input type="text" class="form-control" name="terms_km[]"
                                                                placeholder="{{ __('បញ្ចូលលក្ខខណ្ឌ (ខ្មែរ)') }}"
                                                                required="">
                                                        </div>
                    ...
                    var termField = `
                            <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 mb-2">
                                            <input type="text" class="form-control" name="terms_km[]"
                                            placeholder="{{ __('បញ្ចូលលក្ខខណ្ឌ (ខ្មែរ)') }}" required="">
                                        </div>
                                        <div class="col-md-1 mb-2">
                                            <div class="icon-wrapper">
                                            <button type="button" class="btn btn-sm btn-danger mt-2 removeAttributeTerms" title="Remove Attribute Terms">
