                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                <select class="form-select" name="tax_system" id="tax_system">
                                    <option
                                        {{ get_static_option('tax_system') == 'zone_wise_tax_system' ? 'selected' : '' }}
                        ...
                        <div class="">
                            <div class="col-md-12 p-0 m-0" id="advance_tax_system_settings">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div>
                                        <select name="calculate_tax_based_on" id="calculate_tax_based_on"
                                            class="form-select">
                                            <option
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div>
                                            <select id="display_tax_total" name="display_tax_total" class="form-control">
                                                ...
                                                <option
                                                    {{ get_static_option('display_tax_total') == 'single' ? 'selected' : '' }}
                                                    value="single">
