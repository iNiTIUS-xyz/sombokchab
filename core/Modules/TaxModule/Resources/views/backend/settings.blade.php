            ...
            <form action="{{ route('admin.tax-module.settings') }}" method="post" class="row">
                ...
                <div class="col-xxl-6">
                    <div class="form-group row">
                        <label for="tax_system" class="col-md-4">
                    ...
                    <div class="col-md-12 p-0 m-0" id="advance_tax_system_settings">
                        <div class="form-group row">
                            <label for="prices_entered_with_tax" class="col-md-4">
                        ...
                        <div class="form-group row">
                            <label for="calculate_tax_based_on" class="col-md-4">
                        ...
                        <div class="form-group row">
                            <label for="shipping_tax_class" class="col-md-4">
                        ...
                        <div class="form-group row">
                            <label for="tax_round_at_subtotal" class="col-md-4">
                                {{ __('Rounding') }}
                            </label>
                            <div class="col-md-8">
