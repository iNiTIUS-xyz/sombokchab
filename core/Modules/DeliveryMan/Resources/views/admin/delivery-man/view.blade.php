...
@section('site-title', __('View Delivery Man'))

@section('content')

    <h2 class="common-title-three mb-4"> {{ __('Delivery man details') }}</h2>
    ...
    <form action="{{ route('admin.delivery-man.update', $deliveryMan->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="dashboard-deliveryWrap">
            <div class="row g-4">
                <div class="col-lg-12">
                    <div class="single-flex-dashbaord-two dashboard__card radius-10">
                        <div class="dashboard-single-profile">
                            <div class="error-wrapper">
                                <x-msg.error />
                            </div>
                            <div class="seller-title-flex-contents">
                                <h2 class="dashboard-common-title">{{ __('General Information') }}</h2>
                            </div>
                                ...
                                <div class="custom-form">
                                    <div class="dashboard-flex-input">
                                        <div class="dashboard-input">
                                            ...
                                            <input disabled readonly name="first_name"
                                                value="{{ old('first_name') ?? $deliveryMan->first_name }}" type="text"
                                        ...
                                        <div class="dashboard-input">
                                            <label class="dashboard-label color-light mb-2">{{ __('Last Name') }} <span
                                                    class="text-danger d-none">*</span></label>
                                            <input disabled readonly name="last_name"
                                                value="{{ old('last_name') ?? $deliveryMan->last_name }}" type="text"
                                                class="form--control radius-10"
                                                placeholder="{{ __('Enter your first name') }}">
                                        </div>
                                    </div>
                                    <div class="dashboard-flex-input">
                                        <div class="dashboard-input">
                                            <label class="dashboard-label color-light mb-2">{{ __('Email Address') }} <span
                                                    class="text-danger d-none">*</span></label>
                                            <input disabled readonly name="email"
                                                value="{{ old('email') ?? $deliveryMan->email }}" type="text"
                                        ...
                                        <div class="dashboard-input">
                                            <label class="dashboard-label color-light mb-2">{{ __('Phone Number') }} <span
                                                    class="text-danger d-none">*</span></label>
                                            <input disabled readonly name="phone"
                                                value="{{ old('phone') ?? $deliveryMan->phone }}" type="tel"
                                                class="form--control radius-10"
                                    ...
                                    <div class="dashboard-flex-input">
                                        <div class="dashboard-input">
                                            ...
                                            <div class="dashboard-input-select">
                                                <select disabled readonly name="identity_type" class="js_niceSelect">
                                        ...
                                        <div class="dashboard-input">
                                            ...
                                            <input disabled readonly name="identity_number"
                                                ...
                                                <div class="deliveryMan-uploadImage-item">
                                                    ...
                                                    <div class="deliveryMan-uploadImage-wrap uploadedWrapperView mt-4">
                                                        <div class="deliveryMan-uploadImage-flex">
                                                            ...
                                                            <div class="deliveryMan-uploadImage-contents d-none">
                                                                ...
                                                                <div class="deliveryMan-uploadImage-file mt-4">
                                                                    <a href="#1"
                                                                        ...
                                                                        <input disabled readonly name="identity_image"
                                                                            type="file" class="inputTagView"
                                                                            style="opacity: 0;">
                                                                        {{ __('Choose File') }}
                                                                    </a>
                                                                </div>
                                    ...
                                    <div class="dashboard-flex-input">
                                        <div class="dashboard-input">
                                            <label class="dashboard-label color-light mb-2">{{ __('Delivery man Type') }}
                                                <span class="text-danger d-none">*</span></label>
                                            <div class="dashboard-input-select">
                                                <select disabled readonly name="delivery_man_type" class="js_niceSelect">
                                        ...
                                        <div class="dashboard-input">
                                            <label class="dashboard-label color-light mb-2">{{ __('Delivery Zone') }}
                                                <span class="text-danger d-none">*</span></label>
                                            <div class="dashboard-input-select">
                                                <select disabled readonly name="delivery_zone" class="js_niceSelect">
                                    ...
                                    <div class="dashboard-flex-input">
                                        <div class="dashboard-input">
                                            <label class="dashboard-label color-light mb-2">{{ __('Vehicle Type') }} <span
                                                    class="text-danger d-none">*</span></label>
                                            <div class="dashboard-input-select">
                                                <select disabled readonly name="vehicle_type" class="js_niceSelect">
                                        ...
                                        <div class="dashboard-input">
                                            <label class="dashboard-label color-light mb-2">{{ __('License Number') }}
                                                <span class="text-danger d-none">*</span></label>
                                            <input disabled readonly name="driving_license_number"
                                                ...
                                                <div class="deliveryMan-uploadImage-item">
                                                    <h5 class="deliveryMan-uploadImage-title">
                                                        {{ __('Driving License Image') }} <span
                                                            class="text-danger d-none">*</span></h5>
                                                    <div class="deliveryMan-uploadImage-wrap uploadedWrapperView mt-4">
                                                        <div class="deliveryMan-uploadImage-flex">
                                                            <div class="deliveryMan-uploadImage-thumb uploadImageView">
                                                                {!! render_image(
                                                                ...
                                                                <div class="deliveryMan-uploadImage-file mt-4">
                                                                    <a href="#1"
                                                                        ...
                                                                        <input disabled readonly
                                                                            name="driving_license_image" type="file"
                                ...
                                <div class="custom-form">
                                    <div class="dashboard-flex-input">
                                        <div class="dashboard-input">
                                            ...
                                            <select disabled readonly id="country_id" class="form--control"
                                        ...
                                        <div class="dashboard-input">
                                            ...
                                            <select disabled readonly id="state_id" class="form--control"
                                        ...
                                        <div class="dashboard-input">
                                            ...
                                            <select disabled readonly id="city_id" class="form--control"
                                    ...
                                    <div class="dashboard-flex-input">
                                        <div class="dashboard-input">
                                            ...
                                            <input disabled readonly
                                                value="{{ old('present_zip_code') ?? $presentAddress->zip_code }}"
                ...
                <div class="col-lg-12">
                    <div class="single-flex-dashbaord-two dashboard__card radius-10">
                        <div class="dashboard-single-profile">
                            ...
                            <div class="dashboard-delivery-info custom-form mt-3">
                                <div class="dashboard-flex-input">
                                    <div class="dashboard-input">
                                        <label class="dashboard-label color-light mb-2">{{ __('Country') }}</label>
                                        <select disabled readonly id="permanent_country_id" class="form--control"
                                    ...
                                    <div class="dashboard-input">
                                        <label class="dashboard-label color-light mb-2">{{ __('State') }}</label>
                                        <select disabled readonly id="permanent_state_id" class="form--control"
                                    ...
                                    <div class="dashboard-input">
                                        <label class="dashboard-label color-light mb-2">{{ __('City') }}</label>
                                        <select disabled readonly id="permanent_city_id" class="form--control"
                                ...
                                <div class="dashboard-flex-input">
                                    <div class="dashboard-input">
                                        <label class="dashboard-label color-light mb-2">{{ __('Zip Code') }}</label>
                                        <input disabled readonly
                                            value="{{ old('permanent_zip_code') ?? $permanentAddress->zip_code }}"
            ...
            <div class="row g-4">
                <div class="col-lg-12">
                    <div class="single-flex-dashbaord-two dashboard__card radius-10">
                        <div class="dashboard-single-profile">
                            <div class="seller-title-flex-contents">
                                <h2 class="dashboard-common-title">{{ __('Account Information') }}</h2>
                            </div>
                            <div class="dashboard-delivery-info mt-3">
                                <div class="custom-form">
                                    <div class="dashboard-flex-input">
                                        <div class="dashboard-input">
                                            ...
                                            <input disabled readonly value="{{ old('email') ?? $deliveryMan->email }}"
                                                name="email" value="{{ old('email') ?? '' }}" type="text"
                                                class="form--control radius-10" placeholder="{{ __('Enter Email') }}">
                                        </div>
                                        <div class="dashboard-input">
                                            <label
                                                class="dashboard-label color-light mb-2">{{ __('Phone Number') }}</label>
                                            <input disabled readonly value="{{ old('phone') ?? $deliveryMan->phone }}"
                                                name="phone" value="{{ old('phone') ?? '' }}" type="tel"
                                                class="form--control radius-10"
                                                placeholder="{{ __('Enter Phone Number') }}">
                                        </div>
                                    </div>
                                    <div class="dashboard-flex-input">
                                        <div class="dashboard-input">
                                            ...
                                            <input disabled readonly name="password" value="{{ old('password') ?? '' }}"
                                        ...
                                        <div class="dashboard-input">
                                            ...
                                            <input disabled readonly name="password_confirmation"
                                                        ...
                                                        <div class="deliveryMan-uploadImage-flex">
                                                            ...
                                                            <div class="deliveryMan-uploadImage-contents d-none">
                                                                ...
                                                                <div class="deliveryMan-uploadImage-file mt-4">
                                                                    <a href="#1"
                                                                        class="deliveryMan-uploadImage-file-btn radius-5">
                                                                        <input disabled readonly name="profile_image"
                                                                            type="file" class="inputTagView"
                                                                            style="opacity: 0;">
                                                                        {{ __('Choose File') }}
                                                                    </a>
