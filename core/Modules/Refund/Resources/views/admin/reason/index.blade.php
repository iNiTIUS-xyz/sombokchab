    ...
    <div class="dashboard__card">
        <div class="dashboard__card__header">
            ...
            @can('refund-reason-store')
                <button data-bs-toggle="modal" data-bs-target="#refundReasonModal"
                    class="cmn_btn btn_bg_profile">{{ __('Add Reason') }}</button>
            @endcan
        </div>
                                    ...
                                    <td>
                                        @can('refund-reason-update')
                                            <button data-id="{{ $reason->id }}" data-name="{{ $reason->name }}"
                                                ...
                                                class="cmn_btn btn_bg_profile btn-sm edit-reason">
                                                {{ __('Edit') }}
                                            </button>
                                        @endcan
                                        @can('refund-reason-delete')
                                            <a href="{{ route('admin.refund.reason.delete', $reason->id) }}"
                                                class="cmn_btn btn_bg_danger btn-sm">{{ __('Delete') }}</a>
                                        @endcan
                                    </td>
                                </tr>
                            @endforeach
