                    ...
                    <div class="dashboard__card__header">
                        ...
                        <div class="btn-wrapper">
                            <a class="cmn_btn btn_bg_profile"
                                href="{{ route('admin.all.user') }}">{{ __('Admin Accounts') }}</a>
                        </div>
                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $admin->name }}"
                                            name="name" placeholder="{{ __('Enter name') }}" required="">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $admin->username }}"
                                            name="name" placeholder="{{ __('Enter username') }}" required="">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" value="{{ $admin->email }}"
                                            name="email" placeholder="{{ __('Enter name') }}" required="">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select name="role" class="form-select" required="">
                                            ...
                                            @foreach ($roles as $role)
                                                <option value="{{ $role }}"
                                                    @if (in_array($role, $adminRole)) selected @endif>{{ $role }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
