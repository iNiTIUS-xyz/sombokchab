                    ...
                    <div class="dashboard__card__body custom__form mt-4">
                        ...
                        @if (empty($import_data))
                            <form action="{{ route('admin.city.import.csv.update.settings') }}" method="post"
                                ...
                                <a href="{{ asset('city_domo_import_file.csv') }}" class="btn btn-info text-white" download>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            @php $countries = \Modules\CountryManage\Entities\Country::where('status', 'publish')->get(); @endphp
                                            <td>
                                                <div class="form-group">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p class="text-info">
                                                    {{ __('Select city and only unique cities added automatically according to the selected country and province.') }}
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
