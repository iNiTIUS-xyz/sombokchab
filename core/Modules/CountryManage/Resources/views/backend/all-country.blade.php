    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="btn-wrapper mb-4">
                <button class="cmn_btn btn_bg_profile" data-bs-toggle="modal" data-bs-target="#country_new_modal">{{
                    __('Add New Country') }}</button>
            </div>
            @endcan
                                    ...
                                    <td>
                                        <div class="btn-group badge">
                                            <button type="button"
                                                ...
                                                {{ ucfirst($country->status == 'publish' ? __('Published') :
                                                __('Unpublished')) }}
                                            </button>
