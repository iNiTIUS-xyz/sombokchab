        ...
        <div class="col-lg-12">
            <div class="dashboard__card">
                <div class="dashboard__card__header">
                    ...
                    <a href="{{ asset('province_demo_import_file.csv') }}" class="text-primary" download>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    @php $all_countries = \Modules\CountryManage\Entities\Country::where('status',
                                    'publish')->get() @endphp
                                    <td>
                                        <div class="form-group">
                                            <select class="form-control radius-5 select2_activation" name="country_id"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p class="text-info">
                                            {{ __('Select province and only unique province added automatically
