                ...
                <div class="top-inner-contents search-area top-searchbar-wrapper">
                    <div class="dashboard-flex-contetns">
                        <div class="dashboard-left-flex">
                            <h3 class="dashboard__card__title"> <?php echo e(__('Add Products')); ?> </h3>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'product::components.product-price','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
        ...
        <script>
            $(document).ready(function (){
                ...
                $('#child_category').select2({
                    placeholder:"<?php echo e(__('Select Child Category')); ?>"
                });
            })
            ...
            $(document).on("submit", "#product-create-form", function(e) {
                ...
                send_ajax_request("post", new FormData(e.target), $(this).attr("data-request-route"), function() {
                    ...
                    if (data.success) {
                        ...
                        setTimeout(function() {
                            window.location.href = "<?php echo e(route('vendor.products.create')); ?>";
                        })
                    }
                }, function(xhr) {
...
<?php echo $__env->make('vendor.vendor-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sombokchab\core\Modules/Product\Resources/views/vendor/create.blade.php ENDPATH**/ ?>