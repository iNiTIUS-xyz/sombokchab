                ...
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("shipping-method-create")): ?>
                            <a href="<?php echo e(route('admin.shipping-method.create')); ?>" class="cmn_btn btn_bg_profile">
                                <?php echo e(__("Create Shipping Method")); ?>
                                            ...
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("shipping-method-delete")): ?>
                                                    <?php if(!$method->is_default): ?>
                                                        <a href="<?php echo e(route('admin.shipping-method.destroy', $method->id)); ?>"
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("shipping-method-make-default")): ?>
                                                    <?php if(!$method->is_default): ?>
                                                        <form action="<?php echo e(route('admin.shipping-method.make-default')); ?>"
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sombokchab\core\Modules/ShippingModule\Resources/views/admin/shipping-method/index.blade.php ENDPATH**/ ?>