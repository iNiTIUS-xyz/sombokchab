            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-contents">
                        <h2 class="breadcrumb-title"> <?php echo e(__('Vendor Sign Up')); ?> </h2>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div id="step-1">
                            <form id="vendor-form" method="post" enctype="multipart/form-data" novalidate>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="label-title color-light mb-2"> <?php echo e(__('Owner Name *')); ?> </label>
                                            <input
                                                name="owner_name"
                                                id="owner_name"
                                                type="text"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="label-title color-light mb-2"> <?php echo e(__('Store Name *')); ?> </label>
                                            <input
                                                name="business_name"
                                                id="business_name"
                                                type="text"
                                                class="form--control radius-10"
                                                placeholder="<?php echo e(__('Store Name')); ?>"
                                                required
                                            />
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="label-title color-light mb-2"> <?php echo e(__('Business Category *')); ?> </label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="label-title color-light mb-2"> <?php echo e(__('Passport or National ID *')); ?> </label>
                                            <input
                                                name="passport_nid"
                                                id="passport_nid"
                                                type="text"
                                                class="form--control radius-10"
                                                placeholder="<?php echo e(__('Passport or National ID')); ?>"
                                                required
                                            />
                                ...
                                <div class="form-group">
                                    <div class="box-wrap form-check">
                                        ...
                                        <label class="form-check-label" for="toc_and_privacy">
                                            ...
                                            <a href="<?php echo e(url(get_static_option('toc_page_link'))); ?>" class="text-active">
                                                <?php echo e(__('Terms and Conditions')); ?>

                                            </a> &amp;
                                            <a href="<?php echo e(url(get_static_option('privacy_policy_link'))); ?>" class="text-active">
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        async function checkFieldAvailability(field, value) {
            ...
            try {
                const resp = await fetch("<?php echo e(route('check.vendor.data.availability')); ?>", {
                    method: 'POST',
                    headers: {
            ...
            confirmationResult.confirm(code)
                .then(() => {
                    ...
                    setTimeout(() => {
                        ...
                        form.action = "<?php echo e(route('vendor.vendor_registration')); ?>";
                        form.submit();
                    }, 2000);
                })
                .catch((error) => {
...
<?php echo $__env->make('frontend.frontend-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sombokchab\core\Modules/Vendor\Resources/views/vendor/register/index.blade.php ENDPATH**/ ?>