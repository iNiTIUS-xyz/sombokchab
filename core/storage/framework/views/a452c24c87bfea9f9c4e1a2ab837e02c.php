...
<html lang="en">
    ...
    <body>
                    ...
                    <td class="px-0">
                        ...
                        <?php if($invoice->seller->address): ?>
                            <p class="seller-address">
                                <?php echo e(__('Address')); ?>: <?php echo e($invoice->seller->address); ?>
                        ...
                        <?php if($invoice->seller->code): ?>
                            <p class="seller-code">
                                <?php echo e(__('Discount Code')); ?>: <?php echo e($invoice->seller->code); ?>
                        ...
                        <?php if($invoice->seller->vat): ?>
                            <p class="seller-vat">
                                <?php echo e(__('VAT code')); ?>: <?php echo e($invoice->seller->vat); ?>
                        ...
                        <?php if($invoice->seller->phone): ?>
                            <p class="seller-phone">
                                <?php echo e(__('Phone')); ?>: <?php echo e($invoice->seller->phone); ?>
                    ...
                    <td class="px-0">
                        ...
                        <?php if($invoice->buyer->address): ?>
                            <p class="buyer-address">
                                <?php echo e(__('Address')); ?>: <?php echo e($invoice->buyer->address); ?>
                        ...
                        <?php if($invoice->buyer->code): ?>
                            <p class="buyer-code">
                                <?php echo e(__('Code')); ?>: <?php echo e($invoice->buyer->code); ?>
                        ...
                        <?php if($invoice->buyer->vat): ?>
                            <p class="buyer-vat">
                                <?php echo e(__('VAT code')); ?>: <?php echo e($invoice->buyer->vat); ?>
                        ...
                        <?php if($invoice->buyer->phone): ?>
                            <p class="buyer-phone">
                                <?php echo e(__('Phone')); ?>: <?php echo e($invoice->buyer->phone); ?>
            ...
            <tbody>
                ...
                <?php if($invoice->hasItemOrInvoiceDiscount()): ?>
                    <tr>
                        ...
                        <td class="text-right pl-0"><?php echo e(__('Total Discount')); ?></td>
                        <td class="text-right pr-0">
                ...
                <?php if($invoice->taxable_amount): ?>
                    <tr>
                        <td colspan="<?php echo e($invoice->table_columns - 2); ?>" class="border-0"></td>
                        <td class="text-right pl-0"><?php echo e(__('Taxable Amount')); ?></td>
                        <td class="text-right pr-0">
                ...
                <?php if($invoice->tax_rate): ?>
                    <tr>
                        <td colspan="<?php echo e($invoice->table_columns - 2); ?>" class="border-0"></td>
                        <td class="text-right pl-0"><?php echo e(__('Tax rate')); ?></td>
                        <td class="text-right pr-0">
                ...
                <?php if($invoice->hasItemOrInvoiceTax()): ?>
                    <tr>
                        <td colspan="<?php echo e($invoice->table_columns - 2); ?>" class="border-0"></td>
                        <td class="text-right pl-0"><?php echo e(__('Total Taxes')); ?></td>
                        <td class="text-right pr-0">
                ...
                <?php endif; ?>
                    <tr>
                        <td colspan="<?php echo e($invoice->table_columns - 2); ?>" class="border-0"></td>
                        <td class="text-right pl-0"><?php echo e(__('Total Amount')); ?></td>
        ...
        <?php if($invoice->notes): ?>
            <p>
                <?php echo e(trans('Notes')); ?>: <?php echo $invoice->notes; ?>

            </p>
        <?php endif; ?>

        <p>
            <?php echo e(trans('Amount in words')); ?>: <?php echo e($invoice->getTotalAmountInWords()); ?>

        </p>
        <p>
            <?php echo e(trans('Please pay until')); ?>: <?php echo e($invoice->getPayUntilDate()); ?>
...
<?php /**PATH C:\xampp\htdocs\sombokchab\core\resources\views/vendor/invoices/templates/default.blade.php ENDPATH**/ ?>