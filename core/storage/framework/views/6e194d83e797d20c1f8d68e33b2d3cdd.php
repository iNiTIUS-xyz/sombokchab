                ...
                <td data-label="Image">
                    <div class="d-flex gap-2">
                        <div class="logo-brand product-brand">
                            <?php echo $product?->brand?->image_id ? render_image($product?->brand?->image_id) : ''; ?>
...
<?php endif; ?>
                ...
                <td data-label="Actions">
                    <div class="action-icon">
                        <a href="<?php echo e(route('frontend.products.single', $product->slug)); ?>" class="icon eye"> <i
                                class="las la-eye"></i>
                        </a>
                        <a href="<?php echo e(route($route . '.products.edit', $product->id)); ?>" class="icon edit"> <i
                                class="las la-pen-alt"></i> </a>
                        <a href="<?php echo e(route($route . '.products.clone', $product->id)); ?>" class="icon clone"> <i
                                class="las la-copy"></i> </a>
                        <a data-product-url="<?php echo e(route($route . '.products.destroy', $product->id)); ?>" href="#1"
                            class="delete-row icon deleted"> <i class="las la-trash-alt"></i> </a>
                    </div>
                </td>
            </tr>
    ...
    <div class="pagination">
        <ul class="pagination-list">
            <li class="wow ladeInRight" data-wow-delay="0.0s">
                <a disabled readonly="" href="<?php echo e(!$products['on_first_page'] ? $products['previous_page'] : '#1'); ?>"
            ...
            <li class="wow ladeInLeft" data-wow-delay="0.0s">
                <a href="<?php echo e($products['hasMorePages'] ? $products['next_page'] : '#1'); ?>" class="page-number-arrow">
...
<?php /**PATH C:\wamp64\www\sombokchab\core\Modules/Product\Resources/views/vendor/search.blade.php ENDPATH**/ ?>