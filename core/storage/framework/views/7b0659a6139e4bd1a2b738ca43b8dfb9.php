                        ...
                        <?php $__currentLoopData = $badges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $badge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="badge-item d-flex <?php echo e($badge->id === $singlebadge ? 'active' : ''); ?>"
                                ...
                                <div class="content">
                                    ...
                                    <span
                                        class="badge badge-<?php echo e($badge->type ? 'success bg-success' : 'warning bg-warning'); ?>">
                                        <?php echo e($badge->type ? __('Permanent') : __('Temporary')); ?>
...
<?php /**PATH C:\wamp64\www\sombokchab\core\Modules/Product\Resources/views/components/tags-and-badge.blade.php ENDPATH**/ ?>