    ...
    */
    ...
    $(document).on("click","#vendor-send-message-to-user", function (){
        ...
        if($('#vendor-message-footer #message').val().length > 0 || file !== undefined){
            ...
            send_ajax_request("post", form, "<?php echo e(route("frontend.chat.message-send")); ?>", function (){}, function (response){
...
</script><?php /**PATH C:\wamp64\www\sombokchab\core\Modules/Chat\Resources/views/components/user/user-chat-js.blade.php ENDPATH**/ ?>