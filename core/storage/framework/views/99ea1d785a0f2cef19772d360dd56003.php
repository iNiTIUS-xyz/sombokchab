    ...
    <div class="dashboard__card__body custom__form mt-4">
        <div class="form-group select_product">
            ...
            <select name="product_id[]" id="product_id" class="form-control wide repeater_product_id">
                <option value=""><?php echo e(__('Add Campaign Product')); ?></option>
...
<?php /**PATH C:\wamp64\www\sombokchab\core\Modules/Campaign\Resources/views/vendor/add_new_campaign_product.blade.php ENDPATH**/ ?>