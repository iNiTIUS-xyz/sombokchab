            ...
            <div class="col-lg-12">
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('Shipping Methods Create')); ?></h4>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("shipping-method")): ?>
                            <a class="btn btn-info" href="<?php echo e(route('admin.shipping-method.index')); ?>"><?php echo e(__("Shipping Method List")); ?></a>
                        <?php endif; ?>
                    </div>
                    <div class="dashboard__card__body custom__form dashboard-recent-order">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("shipping-method-store")): ?>
                            <form action="<?php echo e(route('admin.shipping-method.store')); ?>" method="post"
                        ...
                        <?php endif; ?>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="title"><?php echo e(__('Title')); ?>

                                            <input name="title" class="form-control"
                                                placeholder="<?php echo e(__('Write shipping method title')); ?>" value="<?php echo e(old("title") ?? ""); ?>" />
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="cost" name="cost" class="form-control"
                                            placeholder="<?php echo e(__('Cost')); ?>" value="<?php echo e(old("cost") ?? ""); ?>">
                                    </div>
                                </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sombokchab\core\Modules/ShippingModule\Resources/views/admin/shipping-method/create.blade.php ENDPATH**/ ?>