                                            ...
                                            <div class="dashboard__card">
                                                ...
                                                <div class="dashboard__card__body mt-4">
                                                    <div class="row g-4">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="single-input">
                                                                <label class="label-title color-light mb-2"> <?php echo e(__('Description')); ?>
                                            ...
                                            <div class="dashboard__card">
                                                ...
                                                <div class="dashboard__card__body mt-4">
                                                    <div class="row g-4">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="single-input">
                                                                <label class="label-title color-light mb-2"> <?php echo e(__('State *')); ?> </label>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="single-input">
                                                                <label class="label-title color-light mb-2"> <?php echo e(__('City')); ?> </label>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="single-input">
                                                                <label class="label-title color-light mb-2"> <?php echo e(__('Google Map Location')); ?></label>
                                                                ...
                                                                <span class="mt-3"><?php echo e(__('Example: Google Map Embed Code.')); ?></span><pre><code>  &lt;iframe src="https://www.example.com" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"&gt;&lt;/iframe&gt;</code></pre>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="dashboard__card">
                                                ...
                                                <div class="dashboard__card__body mt-4">
                                                    <div class="row g-4">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="single-input">
                                                                <label class="label-title color-light mb-2"> <?php echo e(__('Email Address')); ?>
                                                        ...
                                                        <span class="label-title color-light mt-3"> <?php echo e(__('Store Color Settings')); ?></span>
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="store_color"
                                                                       ...
                                                                       class="form-control" value="<?php echo e($vendor?->vendor_shop_info?->colors['store_color'] ?? ''); ?>"
                                                                       id="store_color">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                                                <label for="store_secondary_color"><?php echo e(__('Secondary Color')); ?></label>
                                                                <input type="text" name="store_secondary_color"
                                                                       ...
                                                                       class="form-control" value="<?php echo e($vendor?->vendor_shop_info?->colors['store_secondary_color'] ?? ''); ?>"
                                                                       id="store_secondary_color">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                                                <label for="store_heading_color"><?php echo e(__('Heading Color')); ?></label>
                                                                <input type="text" name="store_heading_color"
                                                                       ...
                                                                       class="form-control" value="<?php echo e($vendor?->vendor_shop_info?->colors['store_heading_color'] ?? ''); ?>"
                                                                       id="store_heading_color">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                                                <label for="store_paragraph_color"><?php echo e(__('Paragraph Color')); ?></label>
                                                                <input type="text" name="store_paragraph_color"
                                                                       ...
                                                                       class="form-control" value="<?php echo e($vendor?->vendor_shop_info?->colors['store_paragraph_color'] ?? ''); ?>"
...
<?php echo $__env->make('vendor.vendor-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sombokchab\core\Modules/Vendor\Resources/views/vendor/edit.blade.php ENDPATH**/ ?>