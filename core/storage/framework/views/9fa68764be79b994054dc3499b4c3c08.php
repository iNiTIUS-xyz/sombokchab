                ...
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        ...
                        <div class="dashboard__card__header__right">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('campaigns-delete')): ?>
...
<?php endif; ?>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('campaigns-new')): ?>
                                <a href="<?php echo e(route('admin.campaigns.new')); ?>" class="cmn_btn btn_bg_profile">
                                    <?php echo e(__('Add New Campaign')); ?>
                    ...
                    <div class="dashboard__card__body mt-4">
                        <div class="table-wrap table-responsive">
                            <table class="table table-default">
                                <thead>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('campaigns-bulk-action')): ?>
...
<?php endif; ?>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('campaigns-edit')): ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\sombokchab\core\Modules/Campaign\Resources/views/backend/all.blade.php ENDPATH**/ ?>