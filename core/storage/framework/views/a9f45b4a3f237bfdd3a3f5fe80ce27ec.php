                                    ...
                                    <td class="table-btn">
                                        <div class="btn-wrapper">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('assign-delivery-man-orders')): ?>
                                                <a href="<?php echo e(route('admin.assign-delivery-man.assign', $order->id)); ?>"
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sombokchab\core\Modules/DeliveryMan\Resources/views/admin/assign-delivery-man/index.blade.php ENDPATH**/ ?>