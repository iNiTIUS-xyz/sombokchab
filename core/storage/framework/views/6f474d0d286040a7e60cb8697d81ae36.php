                    ...
                    <div class="form-wrapper custom__form mt-4">
                            ...
                            <form id="step1-form" method="POST" novalidate>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="phone" name="phone" class="form-control" 
                                           placeholder="+85512345678 or +8801XXXXXXX or +1XXXXXXXXXX" required>
                        ...
                        <div id="step-3" style="display: none;">
                            <form id="reset-password-form" method="POST">
                                ...
                                <button type="button" class="btn btn-prev step-button-outline mt-4" onclick="prevStep(2)">Back</button>
                            </form>
                        </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        let resendTimeout = 60; // Initial resend timer in seconds
        let resendInterval;
        ...
        function checkPhoneAndSendOTP() {
            ...
            fetch("<?php echo e(route('user.check-phone-existence')); ?>", {
                method: 'POST',
                headers: {
        ...
        function updatePassword() {
            ...
            fetch("<?php echo e(route('user.update-forgot-password')); ?>", {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('input[name="_token"]').value
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sombokchab\core\resources\views/frontend/user/forget-password.blade.php ENDPATH**/ ?>