                                            ...
                                            <div class="dashboard__card">
                                                ...
                                                <div class="dashboard__card__body custom__form mt-4 single-reg-form">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="address" type="text" class="form--control radius-10"><?php echo e($vendor?->vendor_address?->address); ?></textarea>
                                                    </div>
                                                ...
                                                <div class="dashboard__card__body custom__form mt-4 single-reg-form">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="is_varify" class="form-control">
                                                            ...
                                                            <option value="1"
                                                                <?php if($vendor?->vendor_bank_info?->is_varify == 1): ?> selected <?php endif; ?>>
                                                                Verify
                                                            </option>
                                                            <option value="0"
                                                                <?php if($vendor?->vendor_bank_info?->is_varify == 0): ?> selected <?php endif; ?>>
                                                                Rejected
                                                            </option>
                                                        </select>
                                                    </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\sombokchab\core\Modules/Vendor\Resources/views/backend/edit.blade.php ENDPATH**/ ?>