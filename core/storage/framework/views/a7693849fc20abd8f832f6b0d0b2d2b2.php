                            ...
                            <div class="single-shop-details-wrapper padding-left-50">
                                ...
                                <div class="price-update-through mt-4">
                                    <h3 class="ff-rubik flash-prices color-one price" data-main-price="<?php echo e($sale_price); ?>"
                                        ...
                                        <?php echo e(float_amount_with_currency_symbol(calculatePrice($sale_price, $product))); ?> </h3>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="details-tab-wrapper">
                                    ...
                                    <div id="description" class="tab-content-item <?php echo e($product->reviews_count > 0 ? '' : 'active'); ?>">
...
<?php endif; ?>
                                    ...
                                    <div id="reviews" class="tab-content-item <?php echo e($product->reviews_count > 0 ? 'active' : ''); ?> ">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group form-check col-12 mx-4">
                                                                        <input type="checkbox" name="remember"
                                                                               ...
                                                                               id="login_remember">
                                                                        <label class="form-check-label" for="remember"><?php echo e(__('Remember me')); ?>
...
<?php endif; ?>
                                            ...
                                            <div class="sidebar-wrapper-btn">
                                                ...
                                                <?php if(moduleExists("Chat")): ?>
                                                    <?php echo $__env->make("chat::components.live-chat-button", ["from" => "product", "product" => $product], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sombokchab\core\Modules/Product\Resources/views/frontend/details.blade.php ENDPATH**/ ?>