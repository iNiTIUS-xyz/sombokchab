<?php $__env->startSection('site-title', __('Update Product')); ?>
                    ...
                    <div class="dashboard-flex-contetns">
                        <div class="dashboard-left-flex d-flex align-items-center justify-content-between w-100">
                            ...
                            <div class="button-wrappers">
                                <a href="<?php echo e(route('admin.products.all')); ?>" class="btn btn-info"><?php echo e(__('Product List')); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="row g-4">
                    ...
                    <div class="col-xxl-10 col-lg-9 col-md-9">
                        <form data-request-route="<?php echo e(route('admin.products.edit', $product->id)); ?>" method="post"
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['product' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product),'tax_classes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($data['tax_classes'])]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\sombokchab\core\Modules/Product\Resources/views/edit.blade.php ENDPATH**/ ?>